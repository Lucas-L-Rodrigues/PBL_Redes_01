...
# Funcao para se comunicar com um cliente
def conectar_com_cliente(con, cliente):
...
while True:
    ...
    client_thread = threading.Thread(target=conectar_com_cliente, args=(con, cliente)) # Criando uma nova thread para a conexao com "cliente"
    client_thread.start()                                                              # Iniciando a thread
